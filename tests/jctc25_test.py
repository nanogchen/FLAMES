...
sys.path.insert(0, "../")
from flames.q_gen import get_rho_q, get_q_points_all_quads, get_binning_averages
from flames.calc import get_static_sf, order_q_points, get_ISF_corr
...
if __name__ == '__main__':
	...
	trjfile = "../data/sampling_100frames_100ns_oct.xtc"
	grofile = "../data/oct_300K.gro"
	Fr_start=0
	Fr_step=1
	Fr_stop=2000
	Fr_total=2e5
